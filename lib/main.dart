...
class _ChurrascoAppState extends State<ChurrascoApp>{
  ...
  // PALETA DE CORES - cor do fundo, cor do card, cor primaria, cor secundaria, cor do texto, cor do texto de contraste
  // RGB, HEX, nome (green, gray)
        ...
        child: Column(
          ...
          children: [
            ...
            _buildCampo(
              ...
              label: 'Quantidade de molieres',
              icone: Icons.person_outline,
              ),
            SizedBox(height: 16),
            _buildCampo(
              controller: _homensController,
              label: 'Quantidade de homenes',
              icone: Icons.person_outline,
              ),
            SizedBox(height: 16),
